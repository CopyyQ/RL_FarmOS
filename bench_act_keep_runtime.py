...
SNAP = "/tmp/farmos_actkeep_ab_snapshot.pt"
...
def main():
    modes = ("flat", "gate40", "gate45", "gate50", "gate55")
    seeds = [23205684, 24510001, 24510002, 24510003, 24510004]
    cases = []
    for mode in modes:
        for i, seed in enumerate(seeds):
            seat = 1 if seed == 23205684 else (i & 1)
